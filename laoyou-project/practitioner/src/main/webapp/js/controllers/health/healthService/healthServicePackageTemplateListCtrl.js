angular.module('controllers',[]).controller('healthServicePackageTemplateListCtrl',
    ['$scope','$rootScope','$stateParams','$state','GetHealthServicePackageTemplateList','PractitionerUtil',
        function ($scope,$rootScope,$stateParams,$state,GetHealthServicePackageTemplateList,PractitionerUtil) {
