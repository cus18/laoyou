...
angular.module('controllers',[]).controller('bloodSugarRecordCtrl',
    ['$scope','$interval','$rootScope','$stateParams','$state','CreateDetection',
        'GetControlTarget','$filter','$timeout','Global',
        function ($scope,$interval,$rootScope,$stateParams,$state,CreateDetection,
                  GetControlTarget,$filter,$timeout,Global) {
