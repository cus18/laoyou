angular.module('controllers',['ui.calendar','ui.bootstrap']).controller('detectionDiagnoseCtrl',
    ['$scope','$rootScope','$stateParams','$state','$filter',
        'GetDetectionHealthData','PractitionerUtil',
        ...
        function ($scope,$rootScope,$stateParams,$state,$filter,
            ...
            var initHealthData = function(num){
                ...
                if($scope.secondMenu=="bloodSugarCurve"||$scope.secondMenu=="bloodSugarTable") {
                    for(var i=0; i<num; i++)
                    {
                        var bloodSugar = {};
                        var value = {
                            date : PractitionerUtil.getAddDate(date.getTime(),0-i),
                                    ...
                                    function(data) {
                                        ...
                                        angular.forEach(data.responseData, function (value, index, array) {
                                            ...
                                            var reportEvent = {
                                                ...
                                                allDay: true,
                                                start: date,
                                                url: '#/detectionDiagnose/testReport,' + value.testDate
                                            }
                                    ...
                                    function(data) {
                                        ...
                                        angular.forEach(data.responseData, function(value,index,array){
                                            ...
                                            var reportEvent = {
                                                ...
                                                allDay: true,
                                                start: date,
                                                url: '#/detectionDiagnose/diagnoseReport,'+value.recordDate
                                            }
            ...
            $scope.createDiagnoseReport = function(){
                window.WebViewJavascriptBridge.callHandler(
                ...
                connectWebViewJavascriptBridge(function(bridge) {
                    ...
                    bridge.registerHandler("createDiagnoseReportDown", function(data, responseCallback) {
            ...
            $scope.createTestReport = function(){
                window.WebViewJavascriptBridge.callHandler(
                    'createTestReport',
                    function(responseData) {
                    }
                ...
                connectWebViewJavascriptBridge(function(bridge) {
                    ...
                    bridge.registerHandler("createTestReportDown", function(data, responseCallback) {
                        if(data == Global.SUCCESS)
                        {
                            $window.location.reload();
                        }
