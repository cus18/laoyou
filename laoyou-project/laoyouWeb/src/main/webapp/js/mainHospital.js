...
require.config({
    ...
    paths: {
        ...
        "hospitalFactory" : "services/hospitalFactory",
        "hospitalGlobal" : "services/hospitalGlobal",
        "hospitalDirective" : "directives/hospitalDirective",
        "hospitalRoute" : "routes/appHospitalRoute",
        "appHospital" : "modules/appHospital"
    },
    waitSeconds: 0,
    shim: {
        'fullCalendar' : ['moment'],
...
require(['angular','angular-resource','angular-sanitize','ng-file-upload','ng-file-upload-shim','angular-ui-router','angular-locale_zh-cn',
        ...
        'uiBootstrapTpls','hospitalFactory', 'hospitalGlobal','hospitalDirective', 'hospitalRoute','appHospital'],
    function (angular){
