...
import com.yhl.laoyou.common.utils.WechatUtil;
...
public class DoctorMsgTemplate {
  ...
  public static void doctorAppointmentRemindAt5minLater2Sms(String doctorName,String babyName,String doctorPhone,String date,String week,String beginTime,String hospitalName,String userPhone){
      String content =  "【预约成功】尊敬的"+doctorName+"医生，"+babyName+"小朋友家长（"+userPhone+"）预约了您"+date+" ("+week+")"+beginTime+"在"+hospitalName+"的门诊。若您因紧急情况不能按时出诊，请联系客服：400-623-7120。宝大夫祝您工作顺利！";
      SMSMessageUtil.sendMsg(doctorPhone, content);
  }
  ...
  public static void cancelDoctorAppointment2Sms(String doctorName,String babyName,String phone,String date,String week,String beginTime,String hospitalName,String userPhone){
    String content = "【取消预约】尊敬的"+doctorName+"医生，"+babyName+"小朋友家长（"+userPhone+"）取消了您"+date+"("+week+")"+beginTime+" 在"+hospitalName+"的门诊。";
