package com.yhl.laoyou.modules.sys.entity.healthData;

/**
 * Created by sunxiao on 2017/5/15.
 */
public class WeightData extends BaseAtr{
    ...
    public void setSmrwb(String smrwb) {
        this.smrwb = smrwb;
    }
    ...
    public void setSkms(String skms) {
        this.skms = skms;
    }
